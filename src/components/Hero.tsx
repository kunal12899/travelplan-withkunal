  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="container mx-auto px-6 pt-32 pb-24 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <AnimatedSection delay={500}>
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 text-white tracking-tight leading-tight text-shadow-md">
          ...
          <AnimatedSection delay={900}>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button
                size="lg"
                variant="outline"
                className="rounded-full px-8 py-6 text-base bg-white/10 backdrop-blur-sm hover:bg-white/20 text-white border-white/20 hover:border-white/40 shadow-lg transition-all"
              >
                View Demo
              </Button>
            </div>
      ...
      <button
        ...
        className="absolute bottom-12 left-1/2 transform -translate-x-1/2 flex flex-col items-center text-white/70 hover:text-white/100 transition-colors animate-float"
